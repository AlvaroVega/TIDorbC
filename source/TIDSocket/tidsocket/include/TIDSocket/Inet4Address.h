...
#ifndef __TID_SOCKET_INET4_ADDRESS_H__
#define __TID_SOCKET_INET4_ADDRESS_H__
...
class Inet4Address: public virtual InetAddress
{
    ...
    public:
        ...
        // Assign operator
        Inet4Address& operator= (const Inet4Address& addr)
            throw();
...
#endif //__TID_SOCKET_INET4_ADDRESS_H__
