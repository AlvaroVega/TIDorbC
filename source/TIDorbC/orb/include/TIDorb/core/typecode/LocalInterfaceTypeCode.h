/*//////////////////////////////////////////////////////////////////////////////////
//
// File:        LocalInterfaceTypeCode.h
// Description: TypeCode implementation for local interfaces.
//
// Rel:         01.00
...
#ifndef _TIDorb_core_typecode_LocalInterfaceTypeCode_H_
#define _TIDorb_core_typecode_LocalInterfaceTypeCode_H_
...
class LocalInterfaceTypeCode : public ComplexTypeCode
{
  public:
    LocalInterfaceTypeCode()
       throw (TIDThr::SystemException);

    LocalInterfaceTypeCode(const char* id, const char* name)
       throw (TIDThr::SystemException);
