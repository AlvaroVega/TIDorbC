  ...
  throw(CORBA::ORB::InvalidName)
{
  ...
  string corbaloc_str;
  if (url.find(TIDorb::core::util::URL::IIOP_PROTOCOL_2) != string::npos) {
    corbaloc_str = url.substr(strlen(TIDorb::core::util::URL::IIOP_PROTOCOL_2));
  } else if (url.find(TIDorb::core::util::URL::IIOP_PROTOCOL_1) != string::npos) {
    corbaloc_str = url.substr(strlen(TIDorb::core::util::URL::IIOP_PROTOCOL_1));
  } else {
    throw CORBA::ORB::InvalidName();
  }
...
TIDorb::core::comm::iiop::IIOPCorbaloc::create_key(const char* url)
  throw(CORBA::ORB::InvalidName)
{
